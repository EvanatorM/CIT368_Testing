...
public class Validate {
  ...
  public static boolean email(String input) {
    Pattern regex = Pattern.compile("^[a-zA-Z0-9]{2,64}@[a-zA-Z0-9]{2,64}.[a-zA-Z0-9]{2,64}$");
  ...
  public static boolean ip(String input){
    Pattern regex = Pattern.compile("^((1?[0-9]?[0-9])|((2[0-4][0-9])|(25[0-5]))){1}\\.((1?[0-9]?[0-9])|((2[0-4][0-9])|(25[0-5]))){1}\\.((1?[0-9]?[0-9])|((2[0-4][0-9])|(25[0-5]))){1}\\.((1?[0-9]?[0-9])|((2[0-4][0-9])|(25[0-5]))){1}$");
    Matcher match = regex.matcher(input);
    return match.matches();
  }
  ...
  public static boolean md5(String input){
    Pattern regex = Pattern.compile("^[a-f0-9]{32}$");
    Matcher match = regex.matcher(input);
    return match.matches();
  }
}
